...
const en: Dictionary = {
  ...
  vehicle: {
    ...
    viewerFinish: "HOLOGRAM COLOUR",
    viewerLights: "BRIGHTNESS",
  ...
  applications: {
    ...
    form: {
      ...
      invalidEmail: "Enter a valid email address (e.g. name@gmail.com or name@std.iyte.edu.tr).",
      invalidPhone: "Enter a valid phone number (e.g. 0532 123 45 67).",
      duplicate: "An application has already been sent with this email address. To update it, write to voltaris.official@gmail.com.",
